	...
	CommandLineRunner initDatabase(TestRepository testRepository) {
		return new CommandLineRunner() {
			...
			public void run(String... args) throws Exception {
				...
				Test t1 = new Test(1, 1, 1, "Bai test english lv1", 0, "ENG1");
				Test t2 = new Test(2, 1, 2, "Bai test coding lv1", 0, "CODE1");
				Test t3 = new Test(3, 1, 3, "Bai test kien thuc chung lv1", 0, "KNOW1");
				Test t4 = new Test(1, 2, 4, "Bai test english lv2", 0, "ENG2");
				Test t5 = new Test(2, 2, 5, "Bai test coding lv2", 0, "CODE2");
				Test t6 = new Test(3, 2, 6, "Bai test kien thuc chung lv2", 0, "KNOW2");
